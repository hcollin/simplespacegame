import { SystemKeyword } from "./models/SystemModel";
...
const BASEACTIONPOINTCOUNT: number = 3;

export { MAPSizes, MAPDensities, FACTION_COLORS, FACTION_FONTS, FACTION_NAMES, PLAYERCOUNTS, COMMANDPAGINATIONLIMIT, SYSTEMBONUS, BASEACTIONPOINTCOUNT };