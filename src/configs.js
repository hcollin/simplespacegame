...
exports.FACTION_NAMES = exports.FACTION_FONTS = exports.FACTION_COLORS = void 0;
// Possible colors for the faction
exports.FACTION_COLORS = ['#e6194B', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#911eb4', '#42d4f4', '#f032e6', '#bfef45', '#fabed4'];
// Possible fonts for the faction
exports.FACTION_FONTS = [
    "Impact",
    "Averia Serif Libre",
    "Bebas Neue",
    "Carter One",
