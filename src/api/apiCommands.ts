...
import { deleteItem, deleteItemsWhere, getItemsWhere, getItemsWheres, insertOrUpdateItem, listenItemWhere } from "./apiFirebaseGeneral";
...
export async function apiDeleteCommandsForGame(gameId: string) {
