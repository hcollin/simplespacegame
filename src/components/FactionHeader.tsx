...
import { CombatReport, DetailReport, DetailReportType, SystemReport } from "../models/Report";
...
const FactionHeader: FC = () => {
	...
	console.log("show Active Report", activeReportId);
	return (
		<>
			<div
			...
			{activeReportId !== "" && (
				<div>
					...
					{report && report.type === DetailReportType.System && <SystemReportView report={report as SystemReport} close={closeReport} />}
					{report && report.type === DetailReportType.Combat && <CombatViewer combatReport={report as CombatReport} />}
				</div>
			)}
		</>
	);
