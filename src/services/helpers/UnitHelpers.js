...
function unitIsMoving(commands, unit) {
...
exports.unitIsMoving = unitIsMoving;
/**
...
function createShipFromDesign(design, factionId, location) {
    var ship = __assign(__assign({}, design), { id: uuid_1.v4(), damage: 0, morale: 100, shields: design.shieldsMax, location: location, factionId: factionId, experience: 0, name: dataShips_1.shipNameGenerator(design.type) });
    return ship;
}
