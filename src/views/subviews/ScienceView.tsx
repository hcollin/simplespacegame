...
import { FactionModel, FactionTechSetting, TechnologyField } from "../../models/Models";
import { doAdjustTechValues } from "../../services/commands/FactionCommands";
            ...
            <div className="page">
                ...
                <div className={classes.row}>
                    {faction.technologyFields.map((v: FactionTechSetting) => {
                        return <TechnologyFieldWrapper field={v[0]} faction={faction} key={v[0]} rpTotal={pointsGenerated} />
    ...
    return (
        <div className={classes.TechnologyFieldWrapper}>
            ...
            <div className="buttons">
                <Button variant="contained" color={techF[2] === 3 ? "primary" : "default"} onClick={() => doAdjustTechValues(props.field, 3, props.faction.id)}>High</Button>
                <Button variant="contained" color={techF[2] === 2 ? "primary" : "default"} onClick={() => doAdjustTechValues(props.field, 2, props.faction.id)}>Medium</Button>
                <Button variant="contained" color={techF[2] === 1 ? "primary" : "default"} onClick={() => doAdjustTechValues(props.field, 1, props.faction.id)}>Low</Button>
                <Button variant="contained" color={techF[2] === 0 ? "primary" : "default"} onClick={() => doAdjustTechValues(props.field, 0, props.faction.id)}>None</Button>
            </div>
