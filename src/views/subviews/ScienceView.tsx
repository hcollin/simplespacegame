    ...
    createStyles({
        ...
        details: {
            ...
            "& div.req": {
                ...
                flexDirection: "row",
                padding: "0.5rem",
                border: "ridge 3px #0004",
                marginBottom: "0.5rem",
                boxShadow: "inset 0 0 1rem 0.25rem #0004",
                background: "#0004",
                borderRadius: "0.5rem",
...
const ScienceView: FC = () => {
    ...
    function clickTechOld(tech: Technology) {
        if (faction && tech) {
    ...
    function clickTech(tech: Technology) {
        ...
        if (targetTech !== null && targetTech.id === tech.id) {
            setTargetTech(null);
        } else {
            setTargetTech(tech);
        }
    ...
    return (
        <div className={classes.root}>
            <PageContainer image={researchimg} color="#BD7" font={faction.style.fontFamily}>
                ...
                <div>
                    {targetTech === null && <TechCircle onClick={clickTech} />}
                    {targetTech !== null && <TechnologyDetails close={closeTargetTech} tech={targetTech} />}
                </div>
            </PageContainer>
        </div>
    );
...
interface TechonlogyDetailsProps {
    tech: Technology;
    close: () => void;
}
    ...
    return (
        <div className={classes.details}>
            ...
            <div>
                ...
                {props.tech.flavour && <p className="flavour">{props.tech.flavour}</p>}
            </div>
