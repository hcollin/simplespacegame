			...
			<PageContainer image={researchimg} color="#BD7" font={faction.style.fontFamily}>
				...
				<div className={classes.row}>
					{faction.technologyFields.map((v: FactionTechSetting) => {
						return <TechnologyFieldWrapper field={v.field} faction={faction} key={v.field} rpTotal={pointsGenerated} targetTech={targetTech} />;
					})}
				</div>
					...
					<div className={classes.singleTechGrid}>
						...
						<div className="col target">
							...
							<TechCard
								tech={targetTech}
								faction={faction}
								className={`${faction.technology.find((s: string) => s === targetTech.id) !== undefined ? "owned" : ""} `}
								onClick={clickTech}
								highlightMissing={true}
