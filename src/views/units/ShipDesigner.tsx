...
const ShipDesigner: FC = () => {
    ...
    const [{ ship, valid, id }, dispatch] = useReducer<Reducer<ShipDesignerState, ShipDesignerReducerAction>>(
        shipDesignerReducer,
        {
            ship: initialDesign,
            valid: false,
                    ...
                    <div className={classes.shipInfo}>
                        <Grid container>
                            <Grid item xs={12} md={3}>
                                <NameValue
                                    name="Points"
                                    value={`${ship.pointsMax - ship.pointsUsed} / ${ship.pointsMax}`}
                                />
