...
const DesignsView: FC = () => {
    ...
    function editDesign() {
        console.log("edit Design", selectedDesign);
    }

    function removeDesign() {
        console.log("remove Design", selectedDesign);
                        ...
                        return (
                            <div className={classes.layer} key={sd.id}>
                                ...
                                <div className="buttons">
                                    <Button variant="contained" color="primary" onClick={editDesign}><Edit /></Button>
                                    <Button variant="contained" color="secondary" onClick={removeDesign}><Delete /></Button>
                                    <Button variant="contained" color="default" onClick={() => setSelectedDesign(null)}><Cancel /></Button>
                                </div>
                            </div>
                        )
                    }
